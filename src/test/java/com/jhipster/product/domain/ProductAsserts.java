...
import static com.jhipster.product.domain.AssertUtils.bigDecimalCompareTo;
...
public class ProductAsserts {
    ...
    public static void assertProductUpdatableFieldsEquals(Product expected, Product actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getPartNo()).as("check partNo").isEqualTo(actual.getPartNo()))
            .satisfies(e -> assertThat(e.getName()).as("check name").isEqualTo(actual.getName()))
            .satisfies(e -> assertThat(e.getDescription()).as("check description").isEqualTo(actual.getDescription()))
            .satisfies(e -> assertThat(e.getIsForSale()).as("check isForSale").isEqualTo(actual.getIsForSale()))
