package com.jhipster.product.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.jhipster.product.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.jhipster.product.security.DomainUserDetailsService", "createSpringSecurityUser");
