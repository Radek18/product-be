...
/**
 * REST controller for managing {@link com.jhipster.product.domain.Product}.
 */
@RestController
                ...
                Mono<Product> result = productRepository
                    ...
                    .map(existingProduct -> {
                        if (product.getPartNo() != null) {
                            existingProduct.setPartNo(product.getPartNo());
                        }
                        ...
                        if (product.getIsForSale() != null) {
                            existingProduct.setIsForSale(product.getIsForSale());
                        }
